...
namespace Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<ProjectCaseManager, ProjectCaseManager>();
            services.AddTransient<SqlParseRecordManager>();
            services.AddTransient<ProjectHighLightTypeManager>();
            services.AddTransient<ProjectHighLightManager>();
            services.AddTransient<ProjectServiceBusinessManager>();
            services.AddTransient<ProjectServiceBusinessOrderManager>();
            services.AddTransient<IntegralRecordManager>();
            services.AddTransient<InviteRecordManager>();
            services.AddTransient<CourseTypeManager>();
            services.AddTransient<CourseSubmitRecordManager>();
            ...
            services.AddTransient<ProjectCaseService, ProjectCaseService>();
            services.AddTransient<SqlParseRecordService>();
            services.AddTransient<ProjectHighLightTypeService>();
            services.AddTransient<ProjectHighLightService>();
            services.AddTransient<ProjectServiceBusinessService>();
            services.AddTransient<ProjectServiceBusinessOrderService>();
            services.AddTransient<IntegralRecordService>();
            services.AddTransient<InviteRecordService>();
            services.AddTransient<CourseTypeService>();
            services.AddTransient<CourseSubmitRecordService>();
