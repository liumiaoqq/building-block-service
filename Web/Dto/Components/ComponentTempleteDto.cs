namespace Web.Dto
{
    public class ComponentTempleteDto : FullBaseDto
    {
        [Description("文件名称")]
        ...
        public string LanguageWayFormat => LanguageWay.HasValue ? LanguageWay.Value.ToDescription():"" ;

        public List<ComponentTempleteDto> ComponentTempletes { get; set; }

        public ComponentTempleteDto ParentComponentTemplete { get; set; }

        public ComponentTempleteDto()
        {
