...
{
    public class ElementUIProvider : IGengerationTranslateProvider
    {
        ...
        public List<GengerationTranferTree> GengerationTranferTreeRecurrence(List<GengerationComponentTreeData> treeDatas)
        {
            ...
            {
                throw new YouJuException($"ElementUIProvider代理出现错误,具体文件名称:{eachObj.Label},错误信息：{ex.Message},制作人解释:可能是后续升级，使用之前的模板需要重新去调用一下生成模板");
