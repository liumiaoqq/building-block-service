...
{
    public class SpringBootProvider : IGengerationTranslateProvider
    {
        ...
        public List<GengerationTranferTree> GengerationTranferTreeRecurrence(List<GengerationComponentTreeData> treeDatas)
        {
            ...
            {
                //是不是枚举横向扩展
                if (treeData.EnumHorizontal)
                {

                    foreach (var enums in _context.PlanEnums)
                    {
                        _context.PlanEnum = enums;
